classdef EVA0x2D1App < handle
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            EVA0x2D1App.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'EVA')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong EVA
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'EVA').getString, ...
